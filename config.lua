...
lvim.keys.normal_mode["<F3>"] = ":Autoformat<cr>"
lvim.keys.normal_mode["<S-r"] = ":GoRun<cr>"
...
-- -- Additional ins <https://www.lunarvim.org/docs/plugins#user-plugins>
lvim.plugins = {
  {
    "ray-x/go.nvim",
  ...
  --       api_key_cmd = "echo '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'"
  --     })
  --   end
  -- }
  --     {
